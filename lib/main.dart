...
import 'package:provider_ex_flutter/fish_model.dart';
import 'package:provider_ex_flutter/seafish_model.dart';
...
class SpicyB extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text(
          'Tuna:${Provider.of<SeaFish>(context).TunaNumber}',
          style: TextStyle(
              fontSize: 16, color: Colors.red, fontWeight: FontWeight.bold),
        ),
        Text(
          'size:${Provider.of<SeaFish>(context).size}',
          style: TextStyle(
              fontSize: 16, color: Colors.red, fontWeight: FontWeight.bold),
        ),
        SizedBox(
